...
const char *gpu_analytic_calc_jones(
...
__global__ void
analytic_kernel(const ANALYTIC_TYPE at, const FLOAT dipole_height_m,
                const FLOAT *azs, const FLOAT *zas, const int num_directions,
                const unsigned int *freqs_hz, const int num_freqs,
                const FLOAT *delays, const FLOAT *amps, const int num_tiles,
                const FLOAT latitude_rad, const bool norm_to_zenith,
...
extern "C" const char *gpu_analytic_calc_jones(
    const ANALYTIC_TYPE at, const FLOAT dipole_height_m, const FLOAT *d_azs,
    const FLOAT *d_zas, int num_directions, const unsigned int *d_freqs_hz,
    const int num_freqs, const FLOAT *d_delays, const FLOAT *d_amps,
    const int num_tiles, const FLOAT latitude_rad, const uint8_t norm_to_zenith,
  ...
  analytic_kernel<<<gridDim, blockDim>>>(
